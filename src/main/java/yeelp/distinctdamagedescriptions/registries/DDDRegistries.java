...
/**
 * All the registered info for DDD goes here. Damage Types, Creature Types, and Damage Distributions.
 * @author Yeelp
 *
 */
...
{
	/**
	 * The registry for creature types. Still initialized even if creature types aren't used.
	 */
	...
	/**
	 * Initialize the registries, update the explosion distribution, and read from JSON
	 */
