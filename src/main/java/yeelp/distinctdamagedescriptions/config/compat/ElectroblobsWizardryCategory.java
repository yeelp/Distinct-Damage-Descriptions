...
public final class ElectroblobsWizardryCategory {
	...
	@Comment({
		...
		"This can be done manually through the projectile distribution config, this is just to make it easier, as all you need here is the Wizardry damage type it deals, and not a full damage distribution.",
