...
public final class DebugLib
{
	...
	/**
	 * Enable this library. If turned off, all methods short circuit to return a default value.
	 * Disabled when {@link ModConfig#showDotsOn} is false, to avoid doing unnecessary computations.
	 */
	 ...
	 * @param map the map
	 * @return A String representing the entries in the map, in a nicely joined String.
	 */
