...
public class NonNullMap<Key, Value> extends HashMap<Key, Value> implements Map<Key, Value> {
	 ...
	 * 
	 * @param defaultVal the default value stored in the map. The NonNullMap will
	 ...
	 * @param defaultVal the default value to initialize the map with. The
	 ...
	 * 
	 * <p>
	 * For the NonNullMap, if the key has no mapping, the default value is returned
	 * instead.
	 */
	@Override
	 ...
	 * 
	 * <p>
	 * Since the NonNullMap disallows null keys and values, this method throws an
	 * {@link UnsupportedOperationException} if either the key or value is null.
	 * 
	...
	/**
	 * Maps the specified key to the default value, and returns whatever the
	 * original value associated with this key was.
	 * 
	 * @param key the key that should have its mapping set to the default value.
	 * @return the value once associated with this key This method returns null if,
	 *         and only if, this map never contained the specified key.
	 */
	@Nullable
