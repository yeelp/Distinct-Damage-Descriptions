...
public final class DDDDamageSource extends DamageSource {
	...
	/**
	 * Retrieves the immediate causer of the damage, e.g. the arrow entity, not its
	 * shooter
	 */
	@Override
	@Nullable
	...
	/**
	 * Retrieves the true causer of the damage, e.g. the player who fired an arrow,
	 * the shulker who fired the bullet, etc.
	 */
	@Override
	@Nullable
