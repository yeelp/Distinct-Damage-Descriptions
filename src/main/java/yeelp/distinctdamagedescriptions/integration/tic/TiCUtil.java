...
public final class TiCUtil {
	...
	public static Optional<TinkerProjectileHandler> getProjectileHandler(IProjectile projectile) {
		if(projectile instanceof EntityProjectileBase) {
			return Optional.ofNullable(((EntityProjectileBase) projectile).tinkerProjectile);
		}
